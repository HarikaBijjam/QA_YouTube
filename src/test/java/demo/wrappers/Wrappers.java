...
public class Wrappers {
     ...
     * /**
     * Sends the specified text to the web element located by the given locator
     * using the provided WebDriver instance.
     * Waits for the element to be visible before sending keys.
     *
     * @param driver The WebDriver instance to use for locating the element and
     * sending keys.
     * 
    ...
    public static void sendKeysAW(WebDriver driver, By locator, String text) {
        try {
            YouTubeUtils.logStatus("sendKeysAW", "Sending keys");
            ...
            YouTubeUtils.logStatus("sendKeysAW", "Exception while sending keys\n" + e.getMessage());
        }
    }

    /**
     * Clicks on the web element located by the given locator using the provided
     * WebDriver instance.
